...
from novex.mapping import _parse_rate
from novex.merge import merge_databases
from novex.sources.base import safe_next_url
from novex.sources.brusnika import _to_norm as _brusnika_to_norm
from novex.store import _assign_nearest_metro, apply_schema, upsert
...
def test_brusnika_region_prefixes_collide_only_after_split():
    ...
    """
    from novex.sources.base import to_global_id
