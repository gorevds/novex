"""DEPRECATED shim: оставлен для обратной совместимости с novex-scan.service'ом
...
существующий novex-scan.service до его обновления через install.sh.
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    log = logging.getLogger("novex.scan")
    log.warning(
